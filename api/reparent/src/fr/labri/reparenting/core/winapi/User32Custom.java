 ...
 * 
 * This custom version has been added to 
 * the actual version API to complete some missing
 * functions
 */
public interface User32Custom extends StdCallLibrary, WinUser {
	 ...
	 * @return
	 */
	boolean SetProp(HWND hWnd, String lpString, HWND value);
	 ...
	 * @return
	 */
	HWND GetProp(HWND hWnd, String lpString);
